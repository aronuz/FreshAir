<template>
  ...
  <div class="relative overflow-hidden">
    <div class="fixed inset-0 bg-cover bg-center bg-no-repeat z-0 bg-[url('/images/FreshAirHero.png')] background-attachment: fixed;">
    ...
    <UContainer class="w-full grid place-content-around mx-auto mb-8 pb-8 z-10 select-none"> <!-- key="$route.path">  -->
      <Header class="w-fit" />
      <UContainer class="h-fit pb-[300px] max-sm:w-fit overflow-x-auto">
        <NuxtPage/>
        <!-- :key="$route.fullPath" -->
      </UContainer>
      <Footer />
